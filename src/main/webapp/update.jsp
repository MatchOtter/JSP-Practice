							...
							<div class="form-group" style="text-align: center; margin: 0 auto;">
								<div class="btn-group" data-toggle="buttons">
									<label class="btn btn-primary <%= user.getUserGender().equals("남자") ? "active" : "" %>">
									    <input type="radio" name="userGender" autocapitalize="off" value="남자" <%= user.getUserGender().equals("남자") ? "checked" : "" %>>남자
									</label>
									<label class="btn btn-primary <%= user.getUserGender().equals("여자") ? "active" : "" %>">
									    <input type="radio" name="userGender" autocapitalize="off" value="여자" <%= user.getUserGender().equals("여자") ? "checked" : "" %>>여자
									</label>
								</div>
							</div>
						</td>
