...
<head>
	...
	<%
		...
		if (request.getParameter("toID") != null) {
 		...
 		if(userID == null){
 			System.out.println("chat.jsp userID 현재 로그인이 안 된 상태입니다 " + userID);
		...
		if(toID ==null){
			System.out.println("chat.jsp toID 대화 상대가 지정되지 않았습니다. 임시지정합니다. ");
			session.setAttribute("messageType", "오류 메세지");
		...
		if(userID.equals(URLDecoder.decode(toID, "UTF-8"))){
			System.out.println("chat.jsp toID 자기 자신. ");
			session.setAttribute("messageType", "오류 메세지");
			session.setAttribute("messageContent", "자기 자신을 대화상대로 지정할수 없습니다");
			response.sendRedirect("index.jsp");
			return; 
		}
	...
	<script type="text/javascript">
		function autoClosingAlert(selector, delay){
		    var alert = $(selector);  // .alert()는 호출할 필요가 없습니다.
		    alert.show();
			  ...
			  $('#chatList').append('<div class="row">' +
				        '<div class="col-lg-12">' +
				            '<div class="media">' +
				                '<a class="pull-left" href="#">' +
				                    '<img class="media-object img-circle" src="<%= fromProfile %>" alt="" style="width: 30px; height: 30px;">' +
				                '</a>' +
				  ...
				  $('#chatList').append('<div class="row">' +
					        '<div class="col-lg-12">' +
					            '<div class="media">' +
					                '<a class="pull-left" href="#">' +
					                    '<img class="media-object img-circle" src="<%= toProfile %>" alt="" style="width: 30px; height: 30px;">' +
					                '</a>' +
					                '<div class="media-body">' +
					                    '<h4 class="media-heading">' +
					                        chatName +
	    ...
	    <div class="vertical-alignment-helper">
	        <div class="modal-dialog vertical-align-center">
	            <div class="modal-content 
	            	<%=
	            	(messageType != null && messageType.equals("오류 메시지")) ? "panel-warning" : "panel-success"
