				...
				<tbody>
					...
					<tr>
						...
						<td><input class="form-control" type="text" maxlength="50" 
									name="boardTitle" placeholder="글 제목을 입력해주세요" 
									value="<%= board.getBoardTitle() %>"></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>글 내용</h5></td>
						<td><textarea class="form-control" rows="10" name="boardContent" 
									maxlength="2048" placeholder="글 내용을 입력해주세요" style="height: 300px;"
									><%= board.getBoardContent() %></textarea></td>
					</tr>
					<tr>
						...
						<td colspan="2">
							...
							<div class="input-group col-xs-12">
								...
								<input type="text" class="form-control input-lg" disabled="disabled" placeholder="<%= board.getBoardFile() %>">
