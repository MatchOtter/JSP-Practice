	    ...
	    <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
	        <thead>
				...
				<tr>
				    ...
				    <td colspan="3"><a href="boardDownLoad.jsp?boardID=<%=board.getBoardID() %>"><%= board.getBoardFile() %></a><h5></h5></td>
				</tr>
	            <tr>
		        ...
		        <tr>
		            <td colspan="5" style="text-align: right;">
					    ...
					    <% if(userID.equals(board.getUserID())) { %>
					        ...
					        <a href="boardDelete?boardID=<%= board.getBoardID() %>" class="btn btn-primary"
